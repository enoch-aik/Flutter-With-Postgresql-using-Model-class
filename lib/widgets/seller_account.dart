...
class _SellerPageState extends State<SellerPage> {
  ...
  /*...Make sure the field has value entered ...*/
  String _cityValue = '';
  String _cityLatestValue() {
    return _cityValue = ((_cityFieldController.text).isNotEmpty &&
            (_cityFieldController.text).length > 0
    ...
    return GridView.count(
      ...
      children: <Widget>[
        Container(
          ...
          alignment: Alignment.center,
          child:
              imageFile == null ? Text("No Logo") : Image.file(imageFile!),
        ),
