            ...
            child: Column(
              ...
              children: [
                  ...
                  child: StandardElevatedButton(
                    ...
                    onPressed: () {
                      ModelsUsers()
                        ...
                        String companyNameStr = fetchedDataFuture.elementAt(0).toString();
                        String emailStr = fetchedDataFuture.elementAt(1).toString();
                        String fNameStr = fetchedDataFuture.elementAt(2).toString();
                        String mobileStr = fetchedDataFuture.elementAt(3).toString();
                ...
                Flexible(
                  flex: 1,
                  fit: FlexFit.loose,
                  child: Image.memory(Base64Decoder().convert(avatar),width: 200.0,height: 170.0,),
                ),
              ],
            ),
          ),
